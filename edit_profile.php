...
if(isset($_POST['submit'])){
    ...
    $update_user = mysqli_query($connect,"UPDATE `user_form` SET `name`='$fName',`email`='$email',`address`='$address',`phone`='$phone',daerah = '$daerah',poskod='$poskod',negeri='$negeri' WHERE id = '$id'");
if($update_user){
    $status = 1;
...
<body>
<?php if($status == 1){?>
<div class="alert alert-success">Kemaskini Berjaya</div>
<?php }?>
<div class="wrapper">
  <div class="profile">
    <div class="content">
      ...
      <form action="" method="POST">
        ...
        <fieldset>
          ...
          <div class="grid-65">
            <input type="text" name="daerah" id="daerah" tabindex="4"  value="<?= $data_user['daerah']?>" />
          </div>
        </fieldset>
        <fieldset>
          <div class="grid-35">
          ...
          <div class="grid-65">
            <input type="text" name="poskod" id="poskod" tabindex="4"  value="<?= $data_user['poskod']?>" />
          </div>
        </fieldset>
        <fieldset>
          <div class="grid-35">
          ...
          <div class="grid-65">
            <input type="text" name="negeri" id="location" tabindex="4"  value="<?= $data_user['negeri']?>" />
          </div>
        </fieldset>
        <fieldset>
          <div class="grid-35">
            <label for="location">No. Telefon</label>
          </div>
          <div class="grid-65">
        ...
        <fieldset>
          <input type="button" class="Btn cancel" value="Cancel" onclick="window.location = 'utama.php'" />
