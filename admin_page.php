        ...
        <div class="Box-menu">
            <ul class="ul-menu">
                ...
                <li class="li-mneu ">
                    ...
                    <div class="title-menu"><a href="profile_officer.php">Profil AJK Masjid</a> </div>
                </li>
                <li class="li-mneu">
        ...
        <div class="Box-header">
            <div class="box-alert-infomation">
                ...
                <div class="box-infomation">
                    ...
                    <div class="info-name">Admin Masjid</div>
                </div>
            </div>
        </div>
        <div class="Box-elements">
            <div class="stocks-main">
                        <div class="sub-stocks">
                            ...
                            <div class="stocks-titles">Aktiviti - Aktiviti di semua masjid: </div>
            ...
            <div class="box-element-flex">
                <div class="transction" style="top:-5px;">
                    <div class="title-element">User Baru</div>
