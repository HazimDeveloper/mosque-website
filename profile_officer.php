...
$select_data_event = mysqli_query($connect,"SELECT * FROM officer JOIN officer_masjid ON officer.id_officer = officer_masjid.officer_id JOIN masjid ON masjid.id_masjid = officer_masjid.masjid_id");

// $select_data_event = mysqli_query($connect,"SELECT * FROM officer JOIN officer_masjid ON officer.id_officer = officer_masjid.officer_id JOIN masjid ON officer_masjid.masjid_id = masjid.id_masjid");
$i =1;
...
<body>
<div class="Side-bar">
        <div class="Box-logo">Admin Masjid</div>
        <div class="Box-menu">
            <ul class="ul-menu">
                <li class="li-mneu ">
                    ...
                    <div class="title-menu"><a href="admin_page.php">Profil User</a> </div>
                </li>
                <li class="li-mneu Active-menu">
                    ...
                    <div class="title-menu"><a href="admin_page.php">Profil AJK Masjid</a> </div>
                </li>
                <li class="li-mneu">
                    ...
                    <div class="title-menu"><a href="event_admin.php">Aktiviti</a></div>
                </li>
                ...
                <li class="li-mneu">
                    ...
                    <div class="title-menu"><a href="create_officer.php">Tambah AJK Masjid</a></div>
                </li>
                ...
                <li class="li-mneu">
                    ...
                    <div class="title-menu"><a href="create_masjid.php">Tambah Masjid</a></div>
                </li>
                <li class="li-mneu">
                    <svg class="icon-menu" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="512" height="512">
                        <link xmlns="" type="text/css" rel="stylesheet" id="dark-mode-custom-link" />
                    ...
                    <div class="title-menu"><a href="create_daerah.php">Tambah Daerah</a></div>
                </li>
                <li class="li-mneu">
                    <svg class="icon-menu" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="512" height="512">
                        <link xmlns="" type="text/css" rel="stylesheet" id="dark-mode-custom-link" />
                    ...
                    <div class="title-menu"><a href="log.php">Log Aktiviti</a></div>
                </li>
        ...
        <div class="Box-header">
            <div class="box-alert-infomation">
                ...
                <div class="box-infomation">
                    <img class="info-avatar" src="img/logomasjid.jpg">
        ...
        <div class="Box-elements">
            ...
            <div class="box-element-flex">
                <div class="transction" style="top:-5px;">
                    <div class="title-element">Profil AJK Masjid </div>
                    <?php 
