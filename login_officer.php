...
$insert_log = mysqli_query($connect,"INSERT INTO `log`(`id_log`, `id_officer`, `date_time`, `log_desc`) VALUES ('','". $data_officer['id_officer'] ."','$date_time','Ajk Login')");
